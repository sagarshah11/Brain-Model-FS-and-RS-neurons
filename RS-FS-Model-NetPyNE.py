...
RScell['secs']['soma']['geom'] = {'diam': 18.8, 'L': 18.8, 'Ra': 123.0}                           # soma geometry
RScell['secs']['soma']['mechs']['hh'] = {'gnabar': 0.12, 'gkbar': 0.036, 'gl': 0.003, 'el': -70}  # soma hh mechanism
netParams.cellParams['RS'] = RScell
FScell = {'secs': {}}
FScell['secs']['soma'] = {'geom': {}, 'mechs': {}}
FScell['secs']['soma']['geom'] = {'diam': 18.8, 'L': 18.8, 'Ra': 123.0}                           # soma geometry
FScell['secs']['soma']['mechs']['hh'] = {'gnabar': 0.12, 'gkbar': 0.036, 'gl': 0.003, 'el': -70}  # soma hh mechanism
netParams.cellParams['FS'] = FScell
## Population parameters
netParams.popParams['RS'] = {'cellType': 'RS', 'numCells': 10}
netParams.popParams['FS'] = {'cellType': 'FS', 'numCells': 5}
## Synaptic mechanism parameters
netParams.synMechParams['exc'] = {'mod': 'Exp2Syn', 'tau1': 0.1, 'tau2': 5.0, 'e': 0}
netParams.synMechParams ['inh'] = {'mod': 'Exp2Syn','tau1':0.1, 'tau2':5.0, 'e': -70}
netParams.stimSourceParams['TCI'] = {'type': 'NetStim', 'rate': 10, 'noise': 0.5}  #Thalamocortical input
netParams.stimTargetParams['TCI->RS'] = {'source': 'TCI', 'conds': {'cellType': 'RS'}, 'weight': 0.01, 'delay': 5, 'synMech': 'exc'}
...
simConfig.analysis['plotTraces'] = {'include': [1], 'saveFig': True, 'showFig' : True}  # Plot recorded traces for this list of cells
